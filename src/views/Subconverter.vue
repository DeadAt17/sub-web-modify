  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "自用(库：asdlokj1qpi233/subconverter)": "https://sub.delta17.top"
        },
        backendOptions: [
          {value: "https://sub.delta17.top"}
        ],
        remoteConfig: [
          {
            label: "通用",
            options: [
              {
                label: "默认（自用库）",
                value: "https://raw.githubusercontent.com/DeadAt17/rule/refs/heads/main/subconverter.ini"
              }
            ]
          }
        ]
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://sub.delta17.top" : this.getUrlParam(),
        shortType: "https://v1.mk/short",
        remoteConfig: "https://raw.githubusercontent.com/DeadAt17/rule/refs/heads/main/subconverter.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
    ...
    getBackendVersion() {
      this.$axios
          ...
          .then(res => {
            ...
            let a = this.form.customBackend.indexOf("sub.delta17.top") !== -1 || this.form.customBackend.indexOf("sub.delta17.top") !== -1;
          ...
          .catch(() => {
            this.$message.info("自用 subconverter 后端，库来自 asdlokj1qpi233/subconverter");
          });
    }
  }
};
